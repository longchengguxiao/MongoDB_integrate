...
# @Description : This class integrates the basic usage of MongoDB, including insert, find, delete and
# update, and outputting logs in the form of log. Please pay attention to the comments before use. Initialization
